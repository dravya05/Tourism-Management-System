...
<td><?php echo htmlentities($result->Costperperson);?></td>
<td><?php echo htmlentities($result->NoOfPeople);?></td>
<td><?php echo htmlentities($result->TotalCost);?></td>
